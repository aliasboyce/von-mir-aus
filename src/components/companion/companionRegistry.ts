...
export const COMPANION_LINES: CompanionLine[] = [
  ...
  { id: 'hum-29', text: 'Ich tanz mal drüber nach.', textEn: "I'll just dance my way through that one.", category: 'humorvoll', page: '*', trigger: 'leerlauf' },
  { id: 'hum-30', text: 'Frei Schnauze, pi mal Daumen leben.', textEn: 'Living by rough guesswork and gut feeling.', category: 'humorvoll', page: '*', trigger: 'leerlauf' },
  { id: 'hum-31', text: "Irgendwie machen wir das schon, weil wir's doch immer irgendwie schon machen.", textEn: "We'll figure it out somehow — because somehow, we always do.", category: 'humorvoll', page: '*', trigger: 'leerlauf' },
  { id: 'hum-32', text: 'In dem Moment, in dem du gerade wieder an dir zweifelst, denkt sich irgendjemand da draußen: Wow! Die hats drauf.', textEn: "Right as you're doubting yourself again, someone out there is thinking: wow, she's really got this.", category: 'humorvoll', page: '*', trigger: 'leerlauf' },
  { id: 'hum-33', text: 'Wenn du schon guckst, was du alles geplant, aber nicht geschafft hast, dann guck bitte auch, was du alles nicht geplant und trotzdem geschafft hast.', textEn: "If you're already looking at everything you planned but didn't get to, please also look at everything you never planned and did anyway.", category: 'humorvoll', page: '*', trigger: 'leerlauf' },
  { id: 'hum-34', text: 'Ich halt nicht weniger aus, ich spür nur mehr.', textEn: "I don't have less resilience — I just feel more.", category: 'humorvoll', page: '*', trigger: 'leerlauf' },
  { id: 'hum-35', text: 'Wenn ich alles richtig gemacht hätte, wäre ich jetzt jemand anderes.', textEn: "If I'd done everything right, I'd be somebody else right now.", category: 'humorvoll', page: '*', trigger: 'leerlauf' },
  { id: 'hum-36', text: 'Normaler Kartoffelsalat … auf die Eins.', textEn: 'Regular potato salad … order number one.', category: 'humorvoll', page: '*', trigger: 'leerlauf' },
  { id: 'hum-37', text: 'Was machen Sachen?', textEn: "So, how's stuff doing?", category: 'humorvoll', page: '*', trigger: 'leerlauf' },
  { id: 'hum-38', text: 'Bin jetzt in dem Alter, in dem mein Nervensystem Bäume braucht.', textEn: "I'm at the age now where my nervous system needs trees.", category: 'humorvoll', page: '*', trigger: 'leerlauf' },
  { id: 'hum-39', text: 'Man reiche mir die Tür … ich möchte gehen.', textEn: "Pass me the door, would you … I'd like to leave.", category: 'humorvoll', page: '*', trigger: 'leerlauf' },
  { id: 'hum-40', text: 'Brenn mir mal den Film, den du da gerade schiebst.', textEn: "Burn me a copy of whatever's playing in your head right now.", category: 'humorvoll', page: '*', trigger: 'leerlauf' },
  { id: 'hum-41', text: 'Mein Bezug zur Realität ist gerade in der Wäsche!', textEn: "My grip on reality is currently in the wash!", category: 'humorvoll', page: '*', trigger: 'leerlauf' },
